...
| {namae = namae; saitan_kyori = saitan_kyori; temae_list = temae_list} :: rest ->
  if namae = kiten then {namae = kiten; saitan_kyori = 0.0; temae_list = [kiten]} :: rest
  else {namae = namae; saitan_kyori = saitan_kyori; temae_list = temae_list} :: (shokika rest kiten)
