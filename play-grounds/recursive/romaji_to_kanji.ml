...
(*Test*)
let test1 = kyori_wo_hyoji "myogadani" "shinotsuka" global_ekimei_list global_ekikan_list = "The distance between 茗荷谷 and 新大塚 is 1.2"
let test2 = kyori_wo_hyoji "hoge" "ikebukuro" global_ekimei_list global_ekikan_list = "hoge does not exist. "
let test3 = kyori_wo_hyoji "ikebukuro" "hoge" global_ekimei_list global_ekikan_list = "hoge does not exist. "
let test4 = kyori_wo_hyoji "ikebukuro" "myogadani" global_ekimei_list global_ekikan_list = "池袋 and 茗荷谷 are not connected directly."